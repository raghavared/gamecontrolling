# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 09:20:36 2020
...
while True:
    ...
    frame_copy = cv2.rectangle(frame_copy,(width//2,height//2),(width,height),(181, 176, 176),1)
    cv2.putText(frame_copy,'Acceleration',(330,280),cv2.FONT_HERSHEY_SIMPLEX,1,(181, 176, 176),3)
